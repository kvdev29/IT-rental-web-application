...
def list_assets():
    ...
    assets = query.order_by(Asset.asset_tag).paginate(page=page, per_page=15, error_out=False)
...
def edit_asset(asset_id):
    ...
    if form.validate_on_submit():
        ...
        changes = []
        for field in ['name', 'status', 'assigned_to_id', 'location']:
...
def delete_asset(asset_id):
    ...
    return render_template('assets/confirm_delete.html', form=form, asset=asset)
